...
namespace ChartboostSDK {
	public class CBExternal {
		...
		public static void setPIDataUseConsent(CBPIDataUseConsent consent) {
			Log("Unity : setPIDataUseConsent set to = " + consent);
		}
		...
		[DllImport("__Internal")]
		private static extern void _chartBoostsetPIDataUseConsent(CBPIDataUseConsent consent);
		[DllImport("__Internal")]
		...
		public static void setPIDataUseConsent(CBPIDataUseConsent consent) {
			_chartBoostsetPIDataUseConsent(consent);
			Log("iOS : setPIDataUseConsent set to = " + consent);
		}
		public static void setMuted(Boolean muted) {
